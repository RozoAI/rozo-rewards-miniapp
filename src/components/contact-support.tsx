      ...
      {isExpanded && (
        <div className="grid grid-cols-2 gap-2 animate-in slide-in-from-top-2 duration-200">
          <a
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors rounded-md border border-border"
          >
            <svg
          ...
          <button
            type="button"
            className="col-span-2 cursor-pointer flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors rounded-md border border-border"
            onClick={() => {
              capture(DISCOVERY_EVENTS.SUPPORT_CONTACTED, {
                channel: "intercom",
              });
